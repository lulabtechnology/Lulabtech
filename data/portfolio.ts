...
export const portfolioCategories = [
  { id: "corporativa" as const, label: "Webs corporativas", description: "Sitios para empresas, firmas, clínicas, academias y marcas que necesitan una presencia más sólida." },
  { id: "landing" as const, label: "Landing pages", description: "Páginas orientadas a captación, campañas, marcas personales y negocios que venden por WhatsApp o formulario." },
  { id: "software" as const, label: "Software y plataformas", description: "Sistemas internos, portales y soluciones a medida para operación, reservas, logística y administración." }
] as const;
...
export const portfolioProjects: PortfolioProject[] = [
  ...
  },
  {
    ...
    description: "Landing visual para marca de accesorios, colección de producto y venta por WhatsApp con estética cuidada.",
  ...
  },
  {
    ...
    description: "Web corporativa para firma legal con áreas de práctica, presentación de la firma y enfoque de confianza institucional.",
  ...
  },
  {
    ...
    name: "Alcira Trigueros Legal Inmobila",
  ...
  },
  {
    ...
    description: "Web corporativa/brand site para presentar perfil profesional, servicios, propuesta y canales de contacto.",
  ...
  },
  {
    ...
    typeLabel: "Landing page",
    industry: "Abogados",
    description: "Landing legal de alto impacto para presentar firma, confianza y captación de consultas.",
